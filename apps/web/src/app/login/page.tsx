  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md mb-4 px-4">
        <Link
          href="/"
          className="inline-flex items-center text-xs font-semibold text-royal-600 hover:text-royal-700 transition"
        >
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center px-4">
        {/* Stylized Brand Logo */}
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-royal-600 via-royal-500 to-azure-500 p-[2px] shadow-sm mb-3">
          <div className="w-full h-full bg-white rounded-[14px] flex items-center justify-center">
            <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7 text-royal-600">
              <path
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md px-4">
        <div className="bg-white py-8 px-6 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.06)] border border-slate-200/80 rounded-3xl sm:px-10">
          {error && (
            <div
              role="alert"
          ...
          {successUser ? (
            <div className="text-center py-5">
              ...
              <div className="mt-6 flex flex-col space-y-2">
                <Link
                  href="/"
                  className="inline-flex justify-center items-center px-4 py-2.5 rounded-xl bg-royal-600 hover:bg-royal-700 font-semibold text-white shadow-xs transition text-xs"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!requiresMfa ? (
                  ...
                  <div>
                    ...
                    <div className="relative rounded-xl">
                      ...
                      <input
                        ...
                        className="block w-full pl-10 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 text-xs focus:outline-none focus:ring-2 focus:ring-royal-500/30 focus:border-royal-500 focus:bg-white transition"
                      />
                    </div>
                  </div>
                ...
                <div>
                  <label
                    htmlFor="totp"
                    className="block text-xs font-semibold text-royal-700 mb-1"
                  >
                  ...
                  <input
                    ...
                    placeholder="123456"
                    className="block w-full px-4 py-2.5 bg-slate-50 border border-royal-300 rounded-xl text-slate-900 text-center tracking-widest text-lg font-mono focus:outline-none focus:ring-2 focus:ring-royal-500/30 focus:border-royal-500 focus:bg-white transition"
                  />
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center py-2.5 px-4 rounded-xl shadow-xs text-xs font-bold text-white bg-royal-600 hover:bg-royal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-royal-500 disabled:opacity-50 transition"
              >
